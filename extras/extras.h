...
#ifdef EXTRAS_kiteTRAK
#include "kiteTRAK/kiteTRAK.h"
#endif
...
#ifdef EXTRAS_kiteTRAK
	//-----------------------------------------
	//kiteTRAK::kiteTRAKConfigSlot = EXTRAS_DOWN;
	//-----------------------------------------
	//Serial.println("Extra: Enabling kiteTRAK functionality...");
	//extrasConfigAssign(kiteTRAK::kiteTRAKConfigSlot, NULL, NULL);
#endif
