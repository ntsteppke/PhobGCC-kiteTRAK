#ifndef EXTRAS_kiteTRAK_H
#define EXTRAS_kiteTRAK_H

#include <stdbool.h>

/* 
Library used found here: https://github.com/wahlencraft/TM1637-pico
*/

namespace kiteTRAK {
	
	//ExtrasSlot kiteTRAKConfigSlot = EXTRAS_DOWN;

	enum kiteTRAKSettings {
		kiteTRAK_SETTING_ENABLE,
		kiteTRAK_SETTING_UNUSED1,
		kiteTRAK_SETTING_UNUSED2,
		kiteTRAK_SETTING_UNUSED3
	};

	enum kiteTRAKSettingEnable {
		kiteTRAK_ENABLED
	};
	...
	*
	* Init, clear, and set to maxbrightness. */
	void TM1637_start_seq();

}
	#endif // EXTRAS_kiteTRAK_H
